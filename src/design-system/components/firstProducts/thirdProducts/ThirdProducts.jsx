                        ...
                        <Box sx={{ width: '100%', }}>
                            <Box >
                                <Tabs value={value} onChange={handleChange} >
                                    <Tab label="MSI Infinute Series" {...a11yProps(0)} sx={{ fontSize: 15, color: 'grey', p: 1, fontWeight: 600 }} />
                                    <Tab label="MSI Triden" {...a11yProps(1)} sx={{ fontSize: 15, color: 'grey', p: 1, fontWeight: 600 }} />
                                    <Tab label="MSI GL Series" {...a11yProps(2)} sx={{ fontSize: 15, color: 'grey', p: 1, fontWeight: 600 }} />
                                    <Tab label="MSI Nightblade" {...a11yProps(3)} sx={{ fontSize: 15, color: 'grey', p: 1, fontWeight: 600 }} />
                                </Tabs>
                            </Box>
